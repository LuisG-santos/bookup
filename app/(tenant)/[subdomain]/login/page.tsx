...
import { CardTitle, CardDescription } from "@/app/_components/ui/card";
import { Button } from "@/app/_components/ui/button";
import { Label } from "@/app/_components/ui/label";
import { Input } from "@/app/_components/ui/input";
import { CardAction } from "@/app/_components/ui/card";
...
return(
  <div className="flex justify-center items-center min-h-screen bg-[var(--primary)]" >
     <Card className="w-full max-w-sm border border-solid ">
      <CardHeader>
