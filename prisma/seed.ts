...
async function seedDatabase() {
  try {
    ...
    // Nomes criativos para os comércios
    const creativeNames = [
      "Barbearia Vintage",
      "Corte & Estilo",
      "Barba & Navalha",
    ...
    // Endereços fictícios para os comércios
    const addresses = [
    ...
    // Criar 10 comércios com nomes e endereços fictícios
    const commerces = [];
    for (let i = 0; i < 10; i++) {
    ...
    console.error("Erro ao criar os comércios:", error);
  }
}
